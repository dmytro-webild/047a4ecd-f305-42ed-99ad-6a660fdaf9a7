...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "Abstract techno background",
        },
        {
      ...
      features={[
        {
          ...
          description: "High-conversion web apps built with modern stacks (React, Node, Go). Scalable, secure, and lightning-fast.",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-employee-looking-startup-analytics-pc_482257-74478.jpg",
          imageAlt: "Web Dev",
        },
        {
          title: "Mobile App Development",
          description: "Native iOS/Android and Cross-platform solutions that users actually love. Performance-first architecture.",
        ...
        },
        {
          ...
          description: "Strategic, algorithm-proof search engine optimization that puts you on top and keeps you there.",
          imageSrc: "http://img.b2bpic.net/free-photo/gradient-digital-transformation-business-background_53876-104052.jpg",
          imageAlt: "SEO",
        },
        {
          title: "Precision PPC",
          description: "Aggressive, high-ROI paid media campaigns designed to scale your reach and capture market share.",
      ...
      metrics={[
        {
          ...
          value: "1.",
          title: "Discovery",
          description: "Deep audit of your current digital position.",
        ...
        },
        {
          ...
          value: "2.",
          title: "Strategy",
          description: "Mapping the path to your market dominance.",
        ...
        },
        {
          ...
          value: "3.",
          title: "Build",
          description: "Rapid development with agile methodology.",
        ...
        },
        {
          ...
          value: "4.",
          title: "Launch",
          description: "Go-to-market execution and quality assurance.",
        ...
        },
        {
          ...
          value: "5.",
          title: "Optimize",
          description: "Continuous improvement and growth scaling.",
  ...
  <div id="work" data-section="work">
      ...
      products={[
        ...
        {
          id: "w2",
          name: "E-com Scale Strategy",
          price: "$12M Revenue",
          imageSrc: "http://img.b2bpic.net/free-photo/3d-connections-background-with-low-poly-connecting-lines-dots_1048-11882.jpg",
        },
        {
          id: "w3",
          name: "SaaS Platform Re-build",
          price: "-60% Churn",
      ...
      testimonials={[
        {
          id: "1",
          name: "John Doe",
          handle: "CEO, StartupCorp",
          testimonial: "Drogon isn't just an agency; they are our growth engine.",
          rating: 5,
        ...
        },
        {
          id: "2",
          name: "Jane Smith",
          handle: "VP Tech, GrowthCo",
          testimonial: "The most aggressive and effective developers we've worked with.",
          rating: 5,
        ...
        },
        {
          ...
          testimonial: "They don't make excuses, they make things happen.",
          rating: 5,
        ...
        },
        {
          ...
          testimonial: "ROI increased by 300% within the first quarter.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Chris Brown",
          handle: "CEO, ScaleUp",
          testimonial: "Drogon understands the mechanics of digital revenue.",
          rating: 5,
  ...
  <div id="pricing" data-section="pricing">
      ...
      plans={[
        ...
        },
        {
          ...
          badge: "Dominance",
          price: "$25,000/mo",
          subtitle: "Unrestricted agency resources",
          features: [
            "Full Stack Team",
            "Custom Strategies",
            "24/7 Priority",
      ...
      faqs={[
        {
          ...
          content: "Our rapid sprints typically take 4-8 weeks from discovery to market launch.",
        },
        {
          id: "2",
          title: "Can you work with our internal team?",
          content: "Absolutely. We treat our partnership as a force multiplier for your existing efforts.",
        },
        {
          id: "3",
          title: "What tools do you use?",
          content: "We rely on React, Go, Node.js, and AWS for scalable engineering.",
        },
        {
          id: "4",
          title: "Are you specialized in specific industries?",
          content: "We thrive in Fintech, E-commerce, and high-growth SaaS environments.",
        },
        {
          id: "5",
          title: "Is pricing negotiable?",
          content: "We work on fixed pricing based on the scope and project velocity requirements.",
        },
        {
          id: "6",
          title: "Do you provide support post-launch?",
          content: "Yes, we offer ongoing optimization retainers to ensure continuous growth.",
        },
      ]}
